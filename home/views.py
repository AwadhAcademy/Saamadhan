...
from .models import additional_services,consultant
...
def CONSULTANT(request):
    if request.method == "POST":
        ...
        data = consultant(name=name, email=email, Aadhar=Aadhar,DOB=DOB,Phone_number=Phone_number,experience=experience,Father_Husband_Name=Father_Husband_Name,Address=Address,Birth_place=Birth_place,Nationality=Nationality,Gender=Gender,Religion=Religion,Language=Language)
        data.save()
        return render(request,'home/home.html')
    return render(request,'home/CONSULTANT.html')